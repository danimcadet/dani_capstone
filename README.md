...
3. Limited ‘base’ to the following columns:
    ...
    4. From socmo_full:
        ...
        **Base Table**
        ...
        | emi_pell | From Third Way Out: The degree of economic mobility institutions provide; economic mobility index score when considering Pell-eligible student experiences |
        ...
        | pep_pell | From Third Way Out: The Price-to-Earnings Premium (PEP) metric measures the years it takes students to recoup the cost of their education based on the difference between anticipated high school earnings and earnings they experience by attending a particular institution.
        ...
        | hbcu | From IPEDS: A code to indicate whether the institution is one of the Historically Black College or University (HBCU) institutions.
